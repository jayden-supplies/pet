...
| 상황 | 브리핑 |
|---|---|
| 3시간 이내에 뿜었고 이후 움직인 세션이 있음 | "불(물) 뿜은 뒤로 이것들만 남았어." + 목록 |
| 3시간 이내에 뿜었고 이후 아무것도 없음 | "불(물) 뿜은 뒤로 새로 시작한 작업은 아직 없어." |
| 뿜은 적 없음 / 3시간 지남 | 아래 기본 2단 규칙 |

문구의 "불/물"은 **지금 보이는 펫의 속성기**를 따릅니다. 체크포인트를 찍어 둔 뒤
속성기가 없는 펫으로 바꿔 놓았다면 "여기까지 정리한 뒤로" 라고 중립으로 말합니다.
